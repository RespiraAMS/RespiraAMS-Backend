...
/// <summary>
/// Command issued from the HTTP boundary to start the UpdateDoctor saga slice.
/// Registers the process tracker and then dispatches
/// <see cref="UpdateDoctorByManagerCommand"/> to the saga. Carries both the new
/// values to apply and the old values required to compensate a failed step.
/// </summary>
public record StartUpdateDoctorSagaCommand : ICommand
{

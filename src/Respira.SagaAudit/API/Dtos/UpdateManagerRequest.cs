...
/// <summary>
/// HTTP request body for updating a manager on behalf of an admin. Both the new values
/// (to apply) and the old values (to compensate) are required. The role is always Manager,
/// so it is not part of the request.
/// </summary>
public record UpdateManagerRequest
{
    /// <summary>Id of the admin initiating the update.</summary>
    ...
    /// <summary>Current avatar media id of the manager.</summary>
    ...
    /// <summary>New first name to apply to the manager profile.</summary>
    public required string FirstName { get; init; }
    /// <summary>New last name to apply to the manager profile.</summary>
    public required string LastName { get; init; }
    /// <summary>New degrees to apply to the manager profile.</summary>
    public required List<DegreeType> Degrees { get; init; }
    /// <summary>New academic title to apply to the manager profile.</summary>
    public required AcademicTitleEnum AcademicTitle { get; init; }
    /// <summary>New position to apply to the manager profile.</summary>
    public required PositionType Position { get; init; }
    /// <summary>New gender to apply to the manager profile.</summary>
    public GenderType Gender { get; init; }
    /// <summary>New citizen identification number to apply to the manager profile.</summary>
    public required string CitizenIdentificationNumber { get; init; }
    /// <summary>New date of birth to apply to the manager profile, if provided.</summary>
    public DateTimeOffset? DateOfBirth { get; init; }
    /// <summary>New address to apply to the manager profile.</summary>

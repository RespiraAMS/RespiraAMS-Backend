...
namespace Respira.ServiceDefaults.Contracts.Results
{
    ...
    public static class ApplicationStatus
    {
        ...
        /// <summary>
        /// Extension method: check if a string is our supported status code.
        /// </summary>
        /// <param name="customStatusCode">Status code</param>
        /// <returns>True if this status is supported, false otherwise</returns>
        public static bool IsSupportedStatusCode(string customStatusCode)
        {
            customStatusCode = customStatusCode.Trim().ToUpper();
        ...
        /// <summary>
        /// Extension method: check if a string is a success status code.
        /// </summary>
        /// <param name="customStatusCode">Status code</param>
        /// <returns>True if this status code is a success status code, false otherwise</returns>
        /// <exception cref="ArgumentException">Throw if the status code is unsupported</exception>
        ...
        /// <summary>
        /// Extension method: convert a custom status code to a HTTP status code
        /// </summary>
        /// <param name="customStatusCode">Application custom status code</param>
        /// <returns>An integer represent the HTTP status code</returns>
        /// <exception cref="ArgumentException">Throw if custom status code is unsupported</exception>
        public static int ToHttpStatusCode(string customStatusCode)
        {
            return customStatusCode switch
            {
                ...
                SagaUpdated => StatusCodes.Status202Accepted,
                SagaDeleted => StatusCodes.Status202Accepted,

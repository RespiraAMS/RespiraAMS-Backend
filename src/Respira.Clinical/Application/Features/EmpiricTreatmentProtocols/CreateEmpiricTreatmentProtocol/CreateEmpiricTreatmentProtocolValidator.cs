...
public class CreateEmpiricTreatmentProtocolValidator : AbstractValidator<CreateEmpiricTreatmentProtocolCommand>
{
    public CreateEmpiricTreatmentProtocolValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()

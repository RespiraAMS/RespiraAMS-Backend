...
public class GetPagedAntibioticValidatorTest
{
    private readonly GetPagedAntibioticValidator _validator = new();
    ...
    public async Task GetPagedAntibiotic_Success(int page, int size)
    {
        var result = await _validator.ValidateAsync(new GetPagedAntibioticQuery
        {
    ...
    public async Task GetPagedAntibiotic_Fail(int page, int size)
    {
        var result = await _validator.ValidateAsync(new GetPagedAntibioticQuery
        {
            Param = new PaginationParam { Page = page, Size = size },

...
public class GetPagedPathogensValidatorTest
{
    private readonly GetPagedPathogensValidator _validator = new();
    ...
    public async Task GetPagedPathogens_Success(int page, int size)
    {
        var result = await _validator.ValidateAsync(new GetPagedPathogenQuery
        {
    ...
    public async Task GetPagedPathogens_Fail(int page, int size)
    {
        var result = await _validator.ValidateAsync(new GetPagedPathogenQuery
        {
            Param = new PaginationParam { Page = page, Size = size },
